 ...
 *
 * NEVER import this module from a booking/deposit-payment page or the
 * vendor-cancellation-incident admin surface — see pages/checkout.js for
 * the enforced example. Note: this is the flat-color torn-edge primitive
 * only — it does NOT include artcollect's graffiti spray-filter texture,
 * which is intentionally not ported to this platform (see this platform's
 * README and tokens.css).
 */
