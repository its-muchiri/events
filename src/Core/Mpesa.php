...
/**
 * M-Pesa Daraja client (OAuth + STK Push). Per-platform thin wrapper,
 * mirrored from laundry.co.ke's/rider.co.ke's reference implementation for
 * portfolio consistency — see PaymentController's docblock for the note
 * about extracting this to a shared package once needed. Talks to
 * Safaricom's sandbox or production host depending on MPESA_ENV (see
 * .env.example).
 */
final class Mpesa
{
