 ...
 * /api/v1/auth/* (routes/api.php) for fetch()-driven pages like
 * booking-new.php. This is this platform's implementation of the shared
 * identity/auth module (see planning/00-portfolio/shared-architecture.md
 * module 1), mirroring laundry.co.ke's and rider.co.ke's AuthController.
 */
final class AuthController
{
    ...
    public function register(Request $request): void
    {
        ...
        try {
            ...
            // trust-tiering table) so they can browse/book immediately.
            // Vendors stay pending_verification until KYC is approved (see
            // VendorController::onboard), per prd.md's vendor-verification
            // requirement.
        ...
        // No dedicated vendor-onboarding page exists yet (only the JSON
        // POST /api/v1/vendors/onboard endpoint) — send new vendors to the
        // directory rather than a 404 until that view is built.
