...
/**
 * E-commerce store — decor, supplies, and stationery (see
 * planning/05-event-co-ke/prd.md's store scope; rental equipment with
 * date-bound availability is intentionally NOT sold through this
 * controller — see open-questions.md #3, unresolved whether rentals use
 * this store model or the booking-engine model).
 */
